...
![7-30-2-2023](img/7-30-2-2023.png)
...
**Solana**的整个区块历史记录都加载到了Filecoin上，这样基础设施提供商、Solana的个人用户、探索者和索引编制者都可以访问，而无需支付BigTable 或 gatekeeper税。
...
4.**Las Vegas joins the Filecoin community**
